...
ALTER TABLE IF EXISTS "transaction_inputs" DROP CONSTRAINT IF EXISTS fk_inputs;
ALTER TABLE IF EXISTS "transaction_outputs" DROP CONSTRAINT IF EXISTS fk_outputs;
